...
class IserviceFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = \Modules\Health\Entities\Iservice::class;
    ...
    {
        $names = array_column($this->nameIservices, 'name');
        return [
            'name' => $this->faker->unique()->randomElement($names),
            'iid' => $this->faker->numberBetween(10000000, 11000000),
            'price' => $this->faker->numberBetween(1500, 7900),
        ];
    }

    protected $nameIservices = array(
